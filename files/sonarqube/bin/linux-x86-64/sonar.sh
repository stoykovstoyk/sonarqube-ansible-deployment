...
COMMAND_LINE="$JAVA_CMD $XMS $XMX $HAZELCAST_ADDITIONAL -jar $LIB_DIR/sonar-application-10.0.0.68432.jar"
    ...
    then
        ...
        then
            ...
            then
                ...
                pidtest=`$PSEXE -p $pid -o args | grep "sonar-application-10.0.0.68432.jar" | tail -1`
                if [ "X$pidtest" = "X" ]
                then
...
forcestopit() {
    ...
    then
      ...
      ${JAVA_CMD} -jar "lib/sonar-shutdowner-10.0.0.68432.jar"
